...
public strictfp class FloatFFT_1D {
	...
	private void bluestein_complex(final float[] a, final int offa,
			final int isign) {
		...
		if ((nthreads > 1)
			...
			for (int i = 0; i < nthreads; i++) {
				final int firstIdx = i * k;
				final int lastIdx = (i == (nthreads - 1)) ? nBluestein
						: firstIdx + k;
				futures[i] = ConcurrencyUtils.submit(new Runnable() {
					public void run() {
						if (isign > 0) {
							for (int i = firstIdx; i < lastIdx; i++) {
								int idx1 = 2 * i;
								int idx2 = idx1 + 1;
								float im = -ak[idx1] * bk2[idx2] + ak[idx2]
										* bk2[idx1];
	...
	private void bluestein_real_full(final float[] a, final int offa,
			final int isign) {
		final float[] ak = new float[2 * nBluestein];
		int nthreads = ConcurrencyUtils.getNumberOfThreads();
		if ((nthreads > 1)
	...
	/*-------------------------------------------------
	  ...
	  -------------------------------------------------*/
	void radf2(final int ido, final int l1, final float in[], final int in_off,
	...
	/*-------------------------------------------------
	  ...
	  -------------------------------------------------*/
	void radb2(final int ido, final int l1, final float in[], final int in_off,
			final float out[], final int out_off, final int offset) {
		int i, ic;
		float t1i, t1r, w1r, w1i;
		int iw1 = offset;
	...
	/*-------------------------------------------------
	  ...
	  -------------------------------------------------*/
	void radf3(final int ido, final int l1, final float in[], final int in_off,
			final float out[], final int out_off, final int offset) {
	...
	/*-------------------------------------------------
	  ...
	  -------------------------------------------------*/
	void radb3(final int ido, final int l1, final float in[], final int in_off,
			final float out[], final int out_off, final int offset) {
		final float taur = -0.5f;
		final float taui = 0.866025403784438707610604524234076962f;
		int i, ic;
	...
	/*-------------------------------------------------
	  ...
	  -------------------------------------------------*/
	void radf4(final int ido, final int l1, final float in[], final int in_off,
			final float out[], final int out_off, final int offset) {
	...
	/*-------------------------------------------------
	  ...
	  -------------------------------------------------*/
	void radb4(final int ido, final int l1, final float in[], final int in_off,
			final float out[], final int out_off, final int offset) {
	...
	/*-------------------------------------------------
	  ...
	  -------------------------------------------------*/
	void radf5(final int ido, final int l1, final float in[], final int in_off,
			final float out[], final int out_off, final int offset) {
	...
	/*-------------------------------------------------
	  ...
	  -------------------------------------------------*/
	void radb5(final int ido, final int l1, final float in[], final int in_off,
			final float out[], final int out_off, final int offset) {
		final float tr11 = 0.309016994374947451262869435595348477f;
		final float ti11 = 0.951056516295153531181938433292089030f;
		final float tr12 = -0.809016994374947340240566973079694435f;
	...
	void radfg(final int ido, final int ip, final int l1, final int idl1,
			final float in[], final int in_off, final float out[],
	...
	void passf2(final int ido, final int l1, final float in[],
			final int in_off, final float out[], final int out_off,
	...
	/*----------------------------------------------------------------------
	   ...
	   isign is +1 for backward and -1 for forward transforms
	  ----------------------------------------------------------------------*/
	void passf3(final int ido, final int l1, final float in[],
			final int in_off, final float out[], final int out_off,
			final int offset, final int isign) {
		final float taur = -0.5f;
		final float taui = 0.866025403784438707610604524234076962f;
	...
	/*----------------------------------------------------------------------
	   ...
	   isign is +1 for backward and -1 for forward transforms
	  ----------------------------------------------------------------------*/
	void passf4(final int ido, final int l1, final float in[],
			final int in_off, final float out[], final int out_off,
			final int offset, final int isign) {
	...
	/*----------------------------------------------------------------------
	   ...
	   isign is +1 for backward and -1 for forward transforms
	  ----------------------------------------------------------------------*/
	void passf5(final int ido, final int l1, final float in[],
			final int in_off, final float out[], final int out_off,
			final int offset, final int isign)
	...
	void passfg(final int nac[], final int ido, final int ip, final int l1,
			final int idl1, final float in[], final int in_off,
			final float out[], final int out_off, final int offset,
			final int isign) {
	...
	private void cftrec4_th(final int n, final float[] a, final int offa,
			final int nw, final float[] w) {
		int i;
	...
	private int cfttree(int n, int j, int k, float[] a, int offa, int nw,
			float[] w) {
		int i, isplt, m;
		int idx1 = offa - n;
		if ((k & 3) != 0) {
	...
	private void cftleaf(int n, int isplt, float[] a, int offa, int nw,
			float[] w) {
		if (n == 512) {
	...
	private void rftfsub(int n, float[] a, int offa, int nc, float[] c,
			int startc) {
		int k, kk, ks, m;
	...
	private void rftbsub(int n, float[] a, int offa, int nc, float[] c,
			int startc) {
		int k, kk, ks, m;
		float wkr, wki, xr, xi, yr, yi;
		int idx1, idx2;
	...
	private void scale(final float m, final float[] a, int offa, boolean complex) {
		...
		if ((nthreads > 1)
			...
			for (int i = 0; i < nthreads; i++) {
				...
				final int lastIdx = (i == (nthreads - 1)) ? offa + n2
						: firstIdx + k;
				futures[i] = ConcurrencyUtils.submit(new Runnable() {
